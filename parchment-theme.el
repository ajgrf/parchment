...
(autothemer-deftheme parchment
  ...
  ((default                    (:foreground black :background pale-yellow))
   ...
   (header-line                (:background pale-cyan :box t))
   ...
   (mode-line                  (:foreground black :background pale-gray :box (:line-width -1)))
   (mode-line-inactive         (:foreground shadow :background pale-gray :box (:line-width -1)))
   ...
   (doom-modeline-evil-motion-state (:inherit 'doom-modeline-evil-normal-state))
   (doom-modeline-evil-operator-state (:inherit 'doom-modeline-evil-normal-state))
   (doom-modeline-evil-insert-state (:foreground red))
   (doom-modeline-evil-replace-state (:inherit 'doom-modeline-evil-insert-state))
   (doom-modeline-evil-visual-state (:foreground brown))
   ...
   (diff-refine-added          (:inherit 'diff-added :box t))
   (diff-refine-changed        (:background pale-blue))
   (diff-refine-removed        (:inherit 'diff-removed :box t))
   ...
   (org-block-begin-line       (:foreground "#55554e" :background pale-gray :underline t :box "#ccccbb"))
   ...
   (org-todo                   (:foreground red :background pale-red :weight 'bold :box t))
   (org-done                   (:background pale-gray :foreground shadow :weight 'bold :box t))
   (org-upcoming-deadline      (:foreground red))
   (org-habit-alert-face       (:foreground yellow :background brown :box brown))
   (org-habit-alert-future-face (:foreground black :background yellow :box t :strike-through t))
   (org-habit-clear-face       (:foreground pale-blue :background blue :box blue))
   (org-habit-clear-future-face (:foreground blue :background pale-cyan :box t))
   (org-habit-overdue-face     (:foreground pale-red :background red :box red))
   (org-habit-overdue-future-face (:foreground red :background pale-red :box t))
   (org-habit-ready-face       (:foreground pale-green :background green :box green))
   (org-habit-ready-future-face (:foreground green :background pale-green :box t))
   ...
   (hi-blue                    (:background pale-blue :box blue))
   (hi-blue-b                  (:foreground blue :weight 'bold))
   (hi-green                   (:background pale-green :box green))
   (hi-green-b                 (:foreground green :weight 'bold))
   (hi-pink                    (:background pale-red :box red))
   (hi-red-b                   (:foreground red :weight 'bold))
   (hi-yellow                  (:background beige :box brown))
   ...
   (mu4e-conversation-header   (:foreground brown :background beige :box t))
   ...
   (transient-disabled-suffix  (:background pale-red :box red))
   (transient-enabled-suffix   (:background pale-green :box green))
