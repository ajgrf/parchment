...
(autothemer-deftheme parchment
  ...
  ((default                    (:foreground black :background pale-yellow))
   ...
   (mode-line                  (:foreground pale-blue :background blue :box black))
   (mode-line-inactive         (:background pale-gray :box black))
   (mode-line-highlight        (:foreground black :background yellow))
   (mode-line-buffer-id        (:inherit 'mode-line-emphasis))
   (mode-line-emphasis         (:foreground pale-yellow :weight 'bold :distant-foreground black))
